...
BASE   = (191, 78, 78)    # sofa main red
LIGHT  = (214, 108, 104)  # top highlight
DARK   = (150, 54, 58)    # side / seam shadow
DARKER = (110, 38, 44)    # outline
CUSH_H = (224, 132, 128)  # cushion highlight
LEG    = (74, 54, 44)     # wood foot
_T = (0, 0, 0, 0)
...
# backrest (top band), thicker, with highlight lip
rect(3, 2, 36, 6, DARKER)
rect(4, 3, 35, 6, BASE)
rect(4, 3, 35, 3, LIGHT)
# armrests (left + right verticals)
...
for cx in (9, 20):
    ...
    rect(cx + 1, 10, cx + 10, 11, CUSH_H)   # top highlight
    rect(cx + 1, 10, cx + 1, 24, CUSH_H)    # left highlight
